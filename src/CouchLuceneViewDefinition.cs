...
{
    /// <summary>
    /// A definition of a CouchDB Lucene view with a name, an index function, some options (see below)
    /// and a reference to the owning CouchDesignDocument. 
    /// </summary>
    ...
    {     
        ...
        {
            return Db().QueryLucene(this);
        }

        public override string Path()
        {
            return "_fti/" + Doc.Id + "/" + Name;
        }
