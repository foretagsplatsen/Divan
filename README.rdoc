...
This repository originaly forked from Foretagsplatsen/Divan[https://github.com/foretagsplatsen/Divan]
repo when to upgrade solution for CouchDB v1.6.1 and newest dependencies such as
Newtonsoft.Json v7.0.0 and NUnit v3.0.0. It has unit tests (although could benefit 
from more) and at least one sample console project included.
...
== Getting started
1. Install git of course... and clone Divan.
	`git clone git://github.com/vchyzhevskyi/Divan.git`
3. If you use older versions of Visual Studio then 2013 or Monodevelop then I suggest double clicking the Divan.sln. Hopefully the rest works out fine.
...
* CouchDB (1.6.1). Running on a server somewhere, see: http://www.couchdb.org
